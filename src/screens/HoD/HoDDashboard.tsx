...
import { HoDSurveysTab } from './HoDSurveysTab';
import { HoDCalendarTab } from './HoDCalendarTab';
...
export const HoDDashboard = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'StaffTimetable':
        return <HoDStaffTimetableTab />;
      case 'StaffLeave':
        return <HoDStaffLeaveTab />;
      case 'StaffAttendance':
        return <HoDStaffAttendanceTab />;
      case 'StaffMarks':
