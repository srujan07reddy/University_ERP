...
import { DeanHomeTab } from './DeanHomeTab';

import { DeanAnalyticsTab } from './DeanAnalyticsTab';
import { DeanSurveysTab } from './DeanSurveysTab';
import { DeanCalendarTab } from './DeanCalendarTab';
import { DeanApprovalsTab } from './DeanApprovalsTab';
import { DeanStaffTimetableTab } from './DeanStaffTimetableTab';
import { DeanStaffLeaveTab } from './DeanStaffLeaveTab';
import { DeanStaffAttendanceTab } from './DeanStaffAttendanceTab';
import { DeanStaffMarksTab } from './DeanStaffMarksTab';
...
export const DeanDashboard = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'StaffTimetable':
        return <DeanStaffTimetableTab />;
      case 'StaffLeave':
        return <DeanStaffLeaveTab />;
      case 'StaffAttendance':
        return <DeanStaffAttendanceTab />;
      case 'StaffMarks':
