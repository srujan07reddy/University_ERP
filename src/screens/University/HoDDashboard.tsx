...
export const HoDDashboard = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'Analytics':
        return <AnalyticsView role="Head of Department" />;
      case 'Surveys':
        return <SurveyView role="Head of Department" />;
      case 'Calendar':
        return <CalendarView role="Head of Department" />;
      default:
        return (
          <>
            {/* Header */}
            <View className="flex-row justify-between items-center mb-8">
              <View className="flex-row items-center">
                ...
                <View>
                  <Text className="text-slate-400 text-sm font-medium">Departmental Oversight</Text>
                  <Text style={{ color: '#FFFFFF', fontSize: 24, fontWeight: 'bold' }}>HoD Console</Text>
                </View>
              </View>
              ...
              <View className="space-y-6">
                <View>
                  <View className="flex-row justify-between mb-2">
                    <Text className="text-slate-300 text-sm">Internal Assessment Marks</Text>
                    <Text className="text-green-400 text-sm font-bold">94% Uploaded</Text>
                  </View>
                ...
                <View>
                  <View className="flex-row justify-between mb-2">
                    <Text className="text-slate-300 text-sm">Lab Equipment Audit</Text>
                    <Text className="text-blue-400 text-sm font-bold">In Progress</Text>
                  </View>
                  <View className="h-2 bg-white/5 rounded-full overflow-hidden">
                    <View 
                      style={{ width: '45%' as any, backgroundColor: '#3b82f6' }} 
                      className="h-full rounded-full" 
                    />
                  </View>
                </View>
            ...
            <View className="mb-10">
              <Text style={{ color: '#FFFFFF', fontSize: 18, fontWeight: 'bold', marginBottom: 24 }}>HoD Directives</Text>
              <View className="space-y-4">
                <TouchableOpacity className="bg-white/5 p-5 rounded-3xl border border-white/10 flex-row items-center">
                  ...
                  <View className="flex-1">
                    <Text className="text-white font-bold">Semester Project Review</Text>
                    <Text className="text-slate-400 text-xs">Final Year Batch: Nov 05</Text>
                  </View>
                ...
                <TouchableOpacity className="bg-white/5 p-5 rounded-3xl border border-white/10 flex-row items-center">
                  ...
                  <View className="flex-1">
                    <Text className="text-white font-bold">Faculty Meeting</Text>
                    <Text className="text-slate-400 text-xs">Agenda: NAAC documentation</Text>
                  </View>
                  <ChevronRight color="#475569" size={20} />
                </TouchableOpacity>
              </View>
          ...
          <View className="flex-1 bg-black/80 flex-row">
            <View className="w-72 bg-[#0F172A] p-8 border-r border-white/10">
              <View className="flex-row justify-between items-center mb-10">
                <Text className="text-2xl font-bold text-white">HoD Menu</Text>
              ...
              <ScrollView>
                <View className="space-y-2">
                  {[
                    ...
                    { id: 'Courses', icon: BookOpen, label: 'Course Progress' },
